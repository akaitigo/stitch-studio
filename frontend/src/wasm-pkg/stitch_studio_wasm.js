/* @ts-self-types="./stitch_studio_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function convert_image(rgba_data, img_width, img_height, grid_width, grid_height, max_colors) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(rgba_data, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.convert_image(retptr, ptr0, len0, img_width, img_height, grid_width, grid_height, max_colors);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./stitch_studio_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('stitch_studio_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
